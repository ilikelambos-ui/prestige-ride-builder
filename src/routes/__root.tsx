...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Prestige Rides by PR Auto Group — premium pre-owned luxury vehicles in Columbus, Ohio. Easy financing, transparent pricing, and a hand-picked inventory." },
